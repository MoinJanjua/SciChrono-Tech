...
class SettingsViewController: UIViewController ,UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        settingList = ["Dashboard", "Our Story", "Clear Data", "Feedback", "Share App", "Terms & Privacy"]
    ...
    private func NavToWelcome() {
        ...
        private func clearUserData() {
            ...
            UserDefaults.standard.removeObject(forKey: "calculatorHistory") // Standard calculator history
            UserDefaults.standard.removeObject(forKey: "ScientificCalculationHistory") // Scientific calculator history
...
extension SettingsViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.item == 0 {
            ...
            let appID = "SciChronoTech" // Replace with your actual App ID
